...
class TestModulus(BaseOperationTest):
    ...
    valid_test_cases = {
        "remainder": {"a": "10", "b": "3", "expected": "1"},
        "even_division": {"a": "6", "b": "2", "expected": "0"},
...
class TestIntegerDivision(BaseOperationTest):
    ...
    valid_test_cases = {
        "floor_division": {"a": "10", "b": "3", "expected": "3"},
...
class TestPercentage(BaseOperationTest):
    ...
    valid_test_cases = {
        "simple_percent": {"a": "100", "b": "10", "expected": "1000"},
        "quarter": {"a": "50", "b": "200", "expected": "25"},
    }
    invalid_test_cases = {
        "percent_div_by_zero": {
            "a": "5",
            "b": "0",
            "error": ValidationError,
            "message": "Percentage with respect to zero is not allowed",
        },
    }
...
class TestAbsoluteDifference(BaseOperationTest):
    ...
    valid_test_cases = {
        "diff": {"a": "5", "b": "12", "expected": "7"},
        "reverse_diff": {"a": "12", "b": "5", "expected": "7"},
